      ...
      <div class="converter__buttons">
         <button @click="togleEur ^= true; togleNok ^= true" class="converter__swap">
            <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
               <path d="M37.5 4.16663L43.75 10.4166L37.5 16.6666" stroke="black" stroke-width="2" stroke-linecap="round"
                  stroke-linejoin="round" />
               <path d="M12.5 45.8333L6.25 39.5833L12.5 33.3333" stroke="black" stroke-width="2" stroke-linecap="round"
                  stroke-linejoin="round" />
               <path
                  d="M43.75 10.4166H20.8333C16.9656 10.4166 13.2563 11.9531 10.5214 14.688C7.78645 17.4229 6.25 21.1322 6.25 25"
                  stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
               <path
                  d="M6.25 39.5833H29.1667C33.0344 39.5833 36.7437 38.0469 39.4786 35.312C42.2135 32.5771 43.75 28.8677 43.75 25"
                  stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
         </button>
      </div>
